...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '281d366dcf5c807781dcf61fb8637bee',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '鑫印堂', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '万物归一', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xinyintang.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '算卦, 博客, 玄学, 算命, 周易, 八卦', // 网站关键词 英文逗号隔开
